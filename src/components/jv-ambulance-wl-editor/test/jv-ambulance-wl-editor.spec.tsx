 ...
 afterEach(() => { mock.reset(); });
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<jv-ambulance-wl-editor entry-id="test-entry"
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
       components: [JvAmbulanceWlEditor],
       html: `<jv-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></jv-ambulance-wl-editor>`,
    });
